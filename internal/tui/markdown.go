...
func assistantMarkdownStyle() glamouransi.StyleConfig {
	return glamouransi.StyleConfig{
		...
		BlockQuote: glamouransi.StyleBlock{
			StylePrimitive: glamouransi.StylePrimitive{Color: mdNord(nord3)},
			Indent:         mdUint(1),
		...
		Heading: glamouransi.StyleBlock{
			StylePrimitive: glamouransi.StylePrimitive{Color: mdNord(nord8), Bold: mdBool(true)},
			Margin:         mdUint(0),
		},
		...
		H6:     glamouransi.StyleBlock{StylePrimitive: glamouransi.StylePrimitive{Prefix: "###### ", Color: mdNord(nord3), Bold: mdBool(false)}},
		...
		Link:        glamouransi.StylePrimitive{Color: mdNord(nord8), Underline: mdBool(true)},
		LinkText:    glamouransi.StylePrimitive{Color: mdNord(nord7), Bold: mdBool(true)},
		ImageText:   glamouransi.StylePrimitive{Color: mdNord(nord3), Format: "Image: {{.text}} ->"},
		Code: glamouransi.StyleBlock{StylePrimitive: glamouransi.StylePrimitive{
			Prefix:          " ",
			Suffix:          " ",
			Color:           mdNord(nord6),
			BackgroundColor: mdNord(nord2),
		}},
		CodeBlock: glamouransi.StyleCodeBlock{
			StyleBlock: glamouransi.StyleBlock{
				StylePrimitive: glamouransi.StylePrimitive{Color: mdNord(nord4), BackgroundColor: mdNord(nord1)},
				Margin:         mdUint(0),
			},
			Theme: "nord",
		},
