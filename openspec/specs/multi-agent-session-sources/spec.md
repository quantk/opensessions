# multi-agent-session-sources Specification

## Purpose
Define source-aware indexing and browsing behavior for local agent session sources that coexist in one opensession index.
